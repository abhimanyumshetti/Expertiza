class AssignmentController < ApplicationController
  ...
  def new
    ...
    puts "1.new" + @assignment.team_assignment.to_s + " space " + @assignment.team_count.to_s
    @wiki_types = WikiType.find(:all)
    @private = params[:private] == true        
    #calling the defalut values mathods
    get_limits_and_weights
    puts "2.new" + @assignment.team_assignment.to_s + " space " + @assignment.team_count.to_s
  end
